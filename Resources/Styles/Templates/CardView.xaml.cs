...
namespace DirectorioEmpleadosMawi.Resources.Styles.Templates;
    ...
    { 
        var empleado = this.BindingContext as Models.Empleado;
        if (empleado != null) 
        {
            await Shell.Current.GoToAsync("employeeDetailsPage", new ShellNavigationQueryParameters { { "Empleado", empleado } });
        }
    }
}
